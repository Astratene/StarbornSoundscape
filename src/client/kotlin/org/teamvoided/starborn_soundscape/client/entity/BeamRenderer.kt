package org.teamvoided.starborn_soundscape.client.entity
...
class BeamRenderer(context: EntityRendererFactory.Context?) :
    EntityRenderer<BeamRendererEntity>(context) {

    override fun render(
        entity: BeamRendererEntity,
        yaw: Float,
        tickDelta: Float,
        ...
        val cubes = entity.dataTracker.get(BeamRendererEntity.InnerCubes)
        val colour: Int = entity.dataTracker.get(BeamRendererEntity.OuterColour)
        val thickness = entity.dataTracker.get(BeamRendererEntity.OuterThickness)
        val innerColour: Int = entity.dataTracker.get(BeamRendererEntity.InterColour)
        ...
        val opacity: Float = entity.dataTracker.get(BeamRendererEntity.Opacity)
        ...
        val pos = entity.dataTracker.get(BeamRendererEntity.OriginPos).toVec3d()
        val targetPos = entity.dataTracker.get(BeamRendererEntity.TargetPos).toVec3d()
    ...
    fun renderEnds(
        ...
        val modifiedDistance =
            distance.toFloat() + (if (entity.dataTracker.get(BeamRendererEntity.MaxOuterThickness) > 1f) 1f else 0f)
    ...
    override fun shouldRender(entity: BeamRendererEntity?, frustum: Frustum?, x: Double, y: Double, z: Double): Boolean {
        return true
    }


    override fun getTexture(entity: BeamRendererEntity): Identifier {
